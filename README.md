...
- Додавання нового користувача (ім'я, e-mail, телефон, фото профілю).
- Редагування існуючого користувача.
- Видалення користувача з підтвердженням.
- Перевірка полів форми (валідація та повідомлення про помилки).
- Запобігання дублюванню користувачів (за ім'ям або e-mail).
- Збереження даних між запусками додатку (AsyncStorage).
